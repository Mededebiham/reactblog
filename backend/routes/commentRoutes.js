...
// Routen
router.get('/:commentId', commentController.getCommentById); // GET-Anfrage, um einen Kommentar nach ID abzurufen
router.get('/post/:postId', commentController.getCommentsForPost); // GET-Anfrage, um alle Kommentare für einen Beitrag abzurufen
